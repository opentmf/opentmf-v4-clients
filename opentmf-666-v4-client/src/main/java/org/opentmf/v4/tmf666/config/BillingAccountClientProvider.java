...
import org.opentmf.v4.tmf666.client.api.BillingAccountClient;
import org.opentmf.v4.tmf666.client.impl.BillingAccountClientImpl;
...
public class BillingAccountClientProvider implements TmfClientProvider<BillingAccountClient> {

  private final ApplicationContext ctx;

  @Override
  public BillingAccountClient getTmfClient(TmfClientConfig config, String clientId) {
    return new BillingAccountClientImpl(config,
