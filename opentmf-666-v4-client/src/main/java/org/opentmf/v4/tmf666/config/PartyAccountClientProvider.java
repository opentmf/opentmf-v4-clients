...
import org.opentmf.v4.tmf666.client.api.PartyAccountClient;
import org.opentmf.v4.tmf666.client.impl.PartyAccountClientImpl;
...
public class PartyAccountClientProvider
    implements TmfClientProvider<PartyAccountClient> {

  private final ApplicationContext ctx;

  @Override
  public PartyAccountClient getTmfClient(TmfClientConfig config, String clientId) {
    return new PartyAccountClientImpl(config,
