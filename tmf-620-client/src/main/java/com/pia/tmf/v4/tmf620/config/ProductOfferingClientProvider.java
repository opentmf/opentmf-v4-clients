...
import com.pia.tmf.v4.tmf620.client.impl.ProductOfferingClientImpl;
...
public class ProductOfferingClientProvider implements TmfClientProvider<ProductOfferingClient> {

  private final ApplicationContext ctx;

  @Override
  public ProductOfferingClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ProductOfferingClientImpl(config,
