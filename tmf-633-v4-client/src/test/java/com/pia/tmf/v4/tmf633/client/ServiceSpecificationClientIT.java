...
import static com.pia.tmf.v4.hub.helper.MockServerUtils.BASE_URL;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.addDataToMockServerCache;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.deleteDataFromMockServerCache;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.get;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.resetMockServer;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.setUpDynamicDeleteCallback;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.setUpDynamicGetCallback;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.setUpDynamicGetListCallback;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.setUpDynamicJsonPatchCallback;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.setUpDynamicMergePatchCallback;
import static com.pia.tmf.v4.hub.helper.MockServerUtils.setUpDynamicPostCallback;
    ...
    StepVerifier.create(request)
        .expectErrorMatches(
            error -> {
              ...
              var errorDetail = ((ServiceSpecificationClientException) error).getErrorMessage();
