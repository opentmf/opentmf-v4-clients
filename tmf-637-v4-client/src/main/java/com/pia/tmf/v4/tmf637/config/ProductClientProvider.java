package com.pia.tmf.v4.tmf637.config;
...
import com.pia.tmf.v4.tmf637.client.impl.ProductClientImpl;
...
public class ProductClientProvider implements TmfClientProvider<ProductClient> {

  private final ApplicationContext ctx;

  @Override
  public ProductClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ProductClientImpl(config,
