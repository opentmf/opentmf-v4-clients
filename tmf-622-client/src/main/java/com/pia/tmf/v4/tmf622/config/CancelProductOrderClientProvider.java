...
import com.pia.tmf.v4.tmf622.client.impl.CancelProductOrderClientImpl;
...
public class CancelProductOrderClientProvider implements TmfClientProvider<CancelProductOrderClient> {

  private final ApplicationContext ctx;

  @Override
  public CancelProductOrderClient getTmfClient(TmfClientConfig config, String clientId) {
    return new CancelProductOrderClientImpl(config,
