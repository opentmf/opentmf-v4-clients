...
class ProductOrderClientIT extends CoreServiceMockServer {
  ...
  private static final String PRODUCT_ORDER_STATE_CHANGE_EVENT_TYPE =
      "productOrderStateChangeEvent";
    ...
    StepVerifier.create(request)
        .expectErrorMatches(
            error -> {
              ...
              var errorDetail = ((ProductOrderClientException) error).getError();
  ...
  private ExtendedEventSubscription buildExtendedEventSubscription() {
    ...
    extendedSub.setQuery("eventType=" + PRODUCT_ORDER_STATE_CHANGE_EVENT_TYPE);
  ...
  private void deleteDataFromMockServerCache(String path, List<String> ids) {
