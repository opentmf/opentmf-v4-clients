...
import com.pia.tmf.v4.tmf641.test.util.MockServerUtils;
 ...
 */
@SpringBootTest
class ServiceOrderClientIT extends MockServerUtils {

  static String TEST_SERVICE_ORDER_PATH = "serviceOrder";
    ...
    StepVerifier.create(request)
        .expectErrorMatches(
            error -> {
              ...
              var errorDetail = ((ServiceOrderClientException) error).getError();
