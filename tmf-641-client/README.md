...
This library provides a client for Tmf-641 Service Ordering API REST end-point. The library client uses TmfForum tmf641-model library. It supports extensions if mixedIn with ObjectMapper properly.
...
<dependency>
    ...
    <artifactId>tmf-641-client</artifactId>
...
As the client library uses tmf641-model, to access extended object specific parameters, cast the return object to the extend object.
