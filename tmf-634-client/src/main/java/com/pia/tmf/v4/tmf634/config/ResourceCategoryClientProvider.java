...
import com.pia.tmf.v4.tmf634.client.impl.ResourceCategoryClientImpl;
...
public class ResourceCategoryClientProvider
    implements TmfClientProvider<ResourceCategoryClient> {

  private final ApplicationContext ctx;

  @Override
  public ResourceCategoryClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ResourceCategoryClientImpl(config,
