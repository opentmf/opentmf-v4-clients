...
import org.opentmf.v4.tmf634.client.impl.ResourceCatalogClientImpl;
...
public class ResourceCatalogClientProvider
    implements TmfClientProvider<ResourceCatalogClient> {

  private final ApplicationContext ctx;

  @Override
  public ResourceCatalogClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ResourceCatalogClientImpl(config,
