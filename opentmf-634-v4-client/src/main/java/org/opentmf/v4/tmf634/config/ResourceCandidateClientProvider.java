...
import org.opentmf.v4.tmf634.client.api.ResourceCandidateClient;
import org.opentmf.v4.tmf634.client.impl.ResourceCandidateClientImpl;
...
public class ResourceCandidateClientProvider
    implements TmfClientProvider<ResourceCandidateClient> {

  private final ApplicationContext ctx;

  @Override
  public ResourceCandidateClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ResourceCandidateClientImpl(config,
