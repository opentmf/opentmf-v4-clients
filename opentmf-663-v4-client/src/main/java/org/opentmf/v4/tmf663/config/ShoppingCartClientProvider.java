...
import org.opentmf.v4.tmf663.client.impl.ShoppingCartClientImpl;
...
public class ShoppingCartClientProvider implements TmfClientProvider<ShoppingCartClient> {

  private final ApplicationContext ctx;

  @Override
  public ShoppingCartClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ShoppingCartClientImpl(config,
