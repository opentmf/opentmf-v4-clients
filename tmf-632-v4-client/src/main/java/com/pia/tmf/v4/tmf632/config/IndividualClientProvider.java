...
import com.pia.tmf.v4.tmf632.client.impl.IndividualClientImpl;
...
public class IndividualClientProvider implements TmfClientProvider<IndividualClient> {

  private final ApplicationContext ctx;

  @Override
  public IndividualClient getTmfClient(TmfClientConfig config, String clientId) {
    return new IndividualClientImpl(config,
