...
import com.pia.tmf.v4.tmf666.client.impl.BillFormatClientImpl;
...
public class BillFormatClientProvider implements TmfClientProvider<BillFormatClient> {

  private final ApplicationContext ctx;

  @Override
  public BillFormatClient getTmfClient(TmfClientConfig config, String clientId) {
    return new BillFormatClientImpl(config,
