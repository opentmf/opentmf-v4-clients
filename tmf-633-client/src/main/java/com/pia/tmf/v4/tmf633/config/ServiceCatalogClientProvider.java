...
import com.pia.tmf.v4.tmf633.client.impl.ServiceCatalogClientImpl;
...
public class ServiceCatalogClientProvider
    implements TmfClientProvider<ServiceCatalogClient> {

  private final ApplicationContext ctx;

  @Override
  public ServiceCatalogClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ServiceCatalogClientImpl(config,
