...
import com.pia.tmf.v4.tmf633.client.impl.ServiceSpecificationClientImpl;
...
public class ServiceSpecificationClientProvider
    implements TmfClientProvider<ServiceSpecificationClient> {

  private final ApplicationContext ctx;

  @Override
  public ServiceSpecificationClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ServiceSpecificationClientImpl(config,
