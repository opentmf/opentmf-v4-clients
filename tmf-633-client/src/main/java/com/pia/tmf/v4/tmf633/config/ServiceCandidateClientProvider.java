...
import com.pia.tmf.v4.tmf633.client.impl.ServiceCandidateClientImpl;
...
public class ServiceCandidateClientProvider
    implements TmfClientProvider<ServiceCandidateClient> {

  private final ApplicationContext ctx;

  @Override
  public ServiceCandidateClient getTmfClient(TmfClientConfig config, String clientId) {
    return new ServiceCandidateClientImpl(config,
